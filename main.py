...
def parse_args():
    ...
    parser.add_argument('--iteration', type=int, default=1700000, help='The number of training iterations')
    ...
    parser.add_argument('--img_size', type=int, default=200, help='The size of image')
    ...
    # for writer (record loss)
    parser.add_argument('--exp_name', type=str, default='myExp')
